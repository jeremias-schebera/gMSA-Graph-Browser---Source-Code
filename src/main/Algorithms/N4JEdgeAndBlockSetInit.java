 ...
 * @author zeckzer
 */
public class N4JEdgeAndBlockSetInit {
    ...
    public List<EdgeSugiyama> cycleDestroyerAndInitializeEdgesAndBlockSets(/*###START### - FOR BROKEN DATA*/ List<VertexSugiyama> vertexList/*###END### - FOR BROKEN DATA*/) {
        ...
        N4JChromosome guideSequenceChr = sequenceVerticesDataForSugiyama.get(0);
        ...
        for (int vertexIndex = 0; vertexIndex < guideSequencePath.size() - 1; vertexIndex++) {
            ...
            if (alreadySeenVertices.contains(nextVertex)) {
            	System.out.println("The edge from " + currentVertex.getText() + " to " + nextVertex.getText() + " creates a cycle! Very Bad!!!");
        ...
        List<N4JChromosome> otherSequenceVerticesDataForSugiyama = sequenceVerticesDataForSugiyama.subList(1, sequenceVerticesDataForSugiyama.size());
        for (N4JChromosome currentChromosomePath : otherSequenceVerticesDataForSugiyama) {
...
//        System.out.println(startVertex.getId() + " - " +  endVertex.getId());
        ...
        if (edgeExistensCheck.containsKey(startVertexCheck) && edgeExistensCheck.get(startVertexCheck).containsKey(endVertexCheck)) {
            ...
            edge.addN4JChromosomePath(chromosomePath, direction);
            ...
            if (direction.equals(EdgeDirection.BACKWARD)) {
                ...
                edge.createN4JChromosomePaths(chromosomePath);
